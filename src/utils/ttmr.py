...
def get_model(framework, text_type, text_rep, path_prefix, arch='transformer', frontend='cnn', mix_type="cf", audio_rep="mel"):
    save_dir = f"{path_prefix}{framework}/exp/{arch}_{frontend}_{mix_type}_{audio_rep}/{text_type}_{text_rep}"
    ...
    pretrained_object = torch.load(f'{save_dir}/best.pth', map_location='cuda')
